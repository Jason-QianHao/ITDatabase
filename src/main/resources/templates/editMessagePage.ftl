		...
		<div class="dvcontent">
			...
			<div>
				...
				<div class="tabs" style="margin: 30px;">
					<div class="hd">
						<ul>
							 <li class="on" style="box-sizing: initial;-webkit-box-sizing: initial;">修改资源(共享平台接口)</li>
						</ul>
					</div>
					<div class="bd">
														...
														style="padding-top: 30px;">
															...
															<form class="am-form am-form-horizontal"
																...
																<div class="am-form-group">
																	...
																	资源类型:</label>
																	<div class="am-u-sm-9">
																		<select name="messageTypeId" onchange="change(this)">
																			<#if listType??>
																				<#list listType as p>
																...
																<div class="am-form-group">
																	<label for="name" class="am-u-sm-3 am-form-label">
																		资源URL:</label>
																	<div class="am-u-sm-9">
																		<input type="text" id="messageUrl"
																			value="${au.messageUrl}"
																			 name="messageUrl">
																			<small>URL</small>
																	</div>
																</div>
																<input type="hidden" name="oldUrl" value="${au.messageUrl}">
																
																<div class="am-form-group">
																	<label for="name" class="am-u-sm-3 am-form-label">
																		资源提取码:</label>
																	<div class="am-u-sm-9">
																		<input type="text" id="messagePwd" 
																			value="${au.messagePwd}"
																			 name="messagePwd">
																			<small>提取码</small>
																	</div>
